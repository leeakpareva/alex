...
const OPTIONAL_KEYS = {
    ...
    dashboard_push_url: { type: 'string' },
    dashboard_push_secret: { type: 'string' },
...
export async function loadConfig() {
    ...
    try {
        ...
        config = {
            ...
            dashboard_push_url: process.env.DASHBOARD_PUSH_URL,
            // Support both the existing Vercel var name and a dedicated one.
            dashboard_push_secret: process.env.DASHBOARD_PUSH_SECRET || process.env.PUSH_SECRET,
