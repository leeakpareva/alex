...
export async function loadConfig() {
    ...
    try {
        ...
        // Only used when the on-disk config file doesn't exist.
        if (String(err?.message || '').startsWith('Config not found at')) {
            config = {
                ...
                chromadb_tenant: process.env.CHROMADB_TENANT || process.env.CHROMA_TENANT,
                chromadb_database: process.env.CHROMADB_DATABASE || process.env.CHROMA_DATABASE,
